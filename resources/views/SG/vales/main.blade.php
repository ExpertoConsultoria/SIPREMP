        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            ...
            <div>
                <h2 class="text-xl font-bold leading-tight text-gray-800 font dark:text-gray-200">
                    {{ __('Vales de Bienes o Servicios') }}
                </h2>
            </div>
                    ...
                    <div class="container grid grid-cols-5 gap-6 px-8 m-auto mb-6 justify-content-center">
                        <div
                            ...
                            <a href="{{ route('vales.create') }}" class="text-right">
                                ...
                                <p class="mt-24 text-lg text-gray-800 dark:text-gray-400">Crear nuevo vale</p>
                            </a>
                        </div>
                        ...
                        <div
                            ...
                            <a href="{{ route('vales.borradores') }}" class="text-right">
                                ...
                                <p class="mt-24 text-lg text-gray-800 dark:text-gray-400">Vales en borrador </p>
                            </a>
                        </div>
                            ...
                            <a href="{{ route('bandejaentrada.rechazadas') }}" class="text-right">
                                ...
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_99_10923)">
                                        <path
                                            d="M20 0C8.97156 0 0 8.97156 0 20C0 31.0284 8.97156 40 20 40C31.0284 40 40 31.0284 40 20C40 8.97156 31.0284 0 20 0Z"
                                            fill="#F44336" />
                                        <path
                                            d="M27.3649 25.0082C28.0164 25.6601 28.0164 26.7133 27.3649 27.3651C27.0399 27.6901 26.6132 27.8534 26.1863 27.8534C25.7597 27.8534 25.333 27.6901 25.008 27.3651L19.9998 22.3566L14.9915 27.3651C14.6665 27.6901 14.2399 27.8534 13.8132 27.8534C13.3863 27.8534 12.9597 27.6901 12.6347 27.3651C11.9831 26.7133 11.9831 25.6601 12.6347 25.0082L17.6432 20L12.6347 14.9918C11.9831 14.3399 11.9831 13.2867 12.6347 12.6349C13.2865 11.9833 14.3397 11.9833 14.9915 12.6349L19.9998 17.6434L25.008 12.6349C25.6599 11.9833 26.713 11.9833 27.3649 12.6349C28.0164 13.2867 28.0164 14.3399 27.3649 14.9918L22.3563 20L27.3649 25.0082Z"
                                            fill="#FAFAFA" />
                                    </g>
                                    <defs>
                                ...
                                <p class="mt-24 text-lg text-gray-800 dark:text-gray-400">Solicitudes <br> rechazadas
                                </p>
                            </a>
                        </div>
                        ...
                        <div
                            ...
                            <a href="{{ route('vales.send-revised') }}" class="text-right">
                                ...
                                <p class="mt-24 text-lg text-gray-800 dark:text-gray-400">Vales revisados <br> y
                                    enviados</p>
                            </a>
                        </div>
