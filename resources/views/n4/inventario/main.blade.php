            ...
            <div class="grid justify-center overflow-hidden bg-transparent">
                ...
                <div class="container grid grid-cols-4 gap-6 px-8 m-auto justify-content-center mb-6">
                    <div
                        ...
                        <a href="{{ route('inventario.entrada') }}" class="text-right">

                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M36.9492 38.6132H42.9635V41.9032H36.9492V38.6132Z" fill="#515151"/>
                                <path d="M25.4062 27.6372V48H42.9624V44.7157H34.1357V35.8007H42.9624V32.343H29.4029L25.4062 27.6372Z" fill="#515151"/>
                                <path d="M20.9959 25.2153H3.79544L1.02344 29.5305H17.3947L20.9959 25.2153Z" fill="#515151"/>
                                <path d="M5.03906 32.343V48H22.5952V27.689L18.7113 32.343H5.03906Z" fill="#515151"/>
                                <path d="M30.704 29.5305H46.9773L44.2053 25.2153H27.0391L30.704 29.5305Z" fill="#515151"/>
                                <path d="M33.099 9.09638C33.099 4.08056 29.0183 0 24.0026 0C18.9869 0 14.9062 4.08056 14.9062 9.09638C14.9062 14.1122 18.9868 18.1928 24.0026 18.1928C29.0183 18.1928 33.099 14.1121 33.099 9.09638ZM22.5729 13.4926L18.6795 9.59916L20.6682 7.61044L22.5729 9.51506L27.337 4.75097L29.3258 6.73969L22.5729 13.4926Z" fill="#515151"/>
                            </svg>                                

                            <p class="text-lg mt-24">Crear entrada</p>
                        </a>
                    </div>
                    ...
                    <div
                        ...
                        <a href="{{ route('inventario.list') }}" class="text-right">
                            ...
                            <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M21.5417 26.9271C21.5417 26.1183 20.8797 25.4583 20.0729 25.4583H12.7292V31.3333C12.7292 32.4143 11.8518 33.2917 10.7708 33.2917C9.68983 33.2917 8.8125 32.4143 8.8125 31.3333V25.4583H1.46875C0.659958 25.4583 0 26.1183 0 26.9271V45.5313C0 46.3401 0.659958 47 1.46875 47H20.0729C20.8797 47 21.5417 46.3401 21.5417 45.5313V26.9271Z" fill="#515151"/>
                                <path d="M46.9987 26.9271C46.9987 26.1183 46.3368 25.4583 45.5299 25.4583H38.1862V31.3333C38.1862 32.4143 37.3089 33.2917 36.2279 33.2917C35.1469 33.2917 34.2695 32.4143 34.2695 31.3333V25.4583H26.9258C26.117 25.4583 25.457 26.1183 25.457 26.9271V45.5313C25.457 46.3401 26.117 47 26.9258 47H45.5299C46.3368 47 46.9987 46.3401 46.9987 45.5313V26.9271Z" fill="#515151"/>
                                <path d="M34.2721 1.46875C34.2721 0.661917 33.6102 0 32.8034 0H25.4596V5.875C25.4596 6.956 24.5823 7.83333 23.5013 7.83333C22.4203 7.83333 21.543 6.956 21.543 5.875V0H14.1992C13.3904 0 12.7305 0.661917 12.7305 1.46875V20.0729C12.7305 20.8817 13.3904 21.5417 14.1992 21.5417H32.8034C33.6102 21.5417 34.2721 20.8817 34.2721 20.0729V1.46875Z" fill="#515151"/>
                                </g>
                                <defs>
                            ...
                            <p class="text-lg mt-24">Inventario</p>
                        </a>
                    </div>
