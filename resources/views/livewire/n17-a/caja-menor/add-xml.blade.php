<div>
    ...
    <div class="grid grid-cols-3  lg:grid-cols-6 xl:grid-cols-6 gap-6 ">
        ...
        <div class="col-span-3">
            <div class="text-center">
                ...
                <div>
                    <span class="text-rose-600 text-sm">{{ $xml_message }}</span>
                </div>
                @endif
                ...
                <div>
                    <span class="text-green-600 text-sm">{{ $xml_message }}</span>
                </div>
                @endif
            </div>
        </div>
