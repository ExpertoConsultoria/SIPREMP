<div>
    ...
    <form class="p-4 md:p-5" wire:submit.prevent="SaveQuote" autocomplete="off">
        <div class="mb-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div class="col-span-4 mt-2 text-center">
                <input type="file" name="archivo" wire:model="archivo" accept="image/*,.pdf,.txt"
            ...
            <div class="col-span-4">
                ...
                <textarea wire:model.blur="arch_descripcion" name="arch_descripcion" rows="3" placeholder="Describe el contenido del Archivo"
