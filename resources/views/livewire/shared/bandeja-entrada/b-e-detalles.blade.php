        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            ...
            <div>
                <h2 class="text-2xl font-bold leading-tight text-gray-800 font dark:text-gray-200">
                    {{ __('Detalles | Solicitud |') }} {{$memorandum_details->memo_folio}}
                </h2>
            </div>
            ...
            <div
                ...
                <div class="container px-4">
                    <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-6">
                        ...
                        <div>
                            <button type="button" onclick="Livewire.dispatch('openModal', { component: 'shared.components.see-quote', arguments: { quote_id: {{ $memorandum_details->memo_id_cotizacion }} } })"
