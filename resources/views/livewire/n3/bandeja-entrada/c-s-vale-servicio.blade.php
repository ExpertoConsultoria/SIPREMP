            ...
            <div class="container px-4 py-6">
                <div class="grid grid-cols-8 gap-3 items-center justify-center">
                    ...
                    <div class="col-span-6 ml-auto">
                        <button type="button"
                        class="px-5 py-2 text-xs w-full font-medium text-center text-white bg-red-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            RECHAZAR
                        </button>
                    </div>
                </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                        ...
                        <td class="px-4 py-2"> 2 gallos, 1 Tsuru </td>
                        <td class="px-4 py-2">
                            <div class=" flexitems-center mx-auto bg-white border w-1/2 border-gray-400 text-gray-900 text-sm rounded-lg p-2">
                                <span class="mx-auto">$00.00</span>
                            </div>
                        </td>
                        <td class="px-4 py-2">
        ...
        <div class="mt-16">
            <div class="container"> 
                <div class="flex relative items-center w-full dark:bg-gray-800 dark:border-gray-700">
                    <div class="">
                        <button type="button"
                            class="disabled:opacity-25 px-8 py-2 focus:outline- text-white bg-red-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all active:translate-y-1">
                            RECHAZAR
                        </button>
                    </div>
                    ...
                    <div class="ml-auto sm:col-span-2">
                        <div class="text-center col-span-1 ml-auto">
                            <button type="button"
                                class="disabled:opacity-25 px-8 py-2 focus:outline- text-white bg-green-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all active:translate-y-1">
                                REVISAR Y VALIDAR
                            </button>
                        </div>
                    </div>
