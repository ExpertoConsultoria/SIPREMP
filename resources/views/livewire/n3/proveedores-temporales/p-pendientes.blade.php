        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            ...
            <div>
                <h2 class="text-xl font-semibold leading-tight text-gray-800 font dark:text-gray-200">
                    {{ __('Proveedores Pendientes por Aceptar') }}
                </h2>
            </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th wire:click="ordenaPor('Nombre')" class="px-4 py-2 cursor-pointer whitespace-nowrap">
                                Nombre
                                @if ($ordenar == 'Nombre')
                                @if ($direccion == 'asc')
                            ...
                            <th wire:click="ordenaPor('RazonSocial')" class="px-4 py-2 cursor-pointer whitespace-nowrap">
                                Razon Social
                                @if ($ordenar == 'RazonSocial')
                                @if ($direccion == 'asc')
                                <i class="float-right mt-1 fas fa-sort-alpha-asc"></i>
                                @else
                                <i class="float-right mt-1 fas fa-sort-alpha-up-alt"></i>
                            ...
                            <th wire:click="ordenaPor('Persona')" class="px-4 py-2 cursor-pointer whitespace-nowrap">
                                Clasificación
                                @if ($ordenar == 'Persona')
                                @if ($direccion == 'asc')
                                <i class="float-right mt-1 fas fa-sort-alpha-asc"></i>
                            ...
                            <th wire:click="ordenaPor('RFC')" class="px-4 py-2 cursor-pointer whitespace-nowrap">
                                RFC
                                @if ($ordenar == 'RFC')
                                @if ($direccion == 'asc')
                                <i class="float-right mt-1 fas fa-sort-alpha-asc"></i>
                            ...
                            <th wire:click="ordenaPor('Telefono')" class="px-4 py-2 cursor-pointer whitespace-nowrap">
                                Telefono
                                @if ($ordenar == 'Telefono')
                                @if ($direccion == 'asc')
                                <i class="float-right mt-1 fas fa-sort-alpha-asc"></i>
                    ...
                    <tbody>
                        @foreach($temporary_list as $proveedor)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-4 py-2 text-center">
                                    <x-button-icons icon="eye"  wire:click="getDetails({{$proveedor->id}})"/>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                @if ($temporary_list->hasPages())
                    <div class="px-6 py-3">
