<div>
    <x-slot name="header">
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            ...
            <div class="grid" style="justify-content: end; padding-right: 5.5rem">
                <a href="{{ route('reportescajamenor') }}">
    ...
    <div class="py-8">
        <div class="max-w-screen-xl mx-auto">
            {{-- Table --}}
            <div
                class="mt-4 text-gray-900 bg-white border-gray-200 rounded-lg shadow-lg shadow-gray-300 dark:shadow-zinc-700 w-30 dark:text-gray-300 dark:bg-zinc-800 dark:border-zinc-800">
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="px-6 py-3">
                                    {{ $report->rcm_partida_presupuestal }}
                                </th>
                                <th class="px-6 py-3">
                                    {{ $report->rcm_ejercicio }}
                                </th>
                                <th class="px-6 py-3">
                                    {{ $monto->month_name }}
                                </th>
            ...
            <div class="mt-8">
                <div class="container">
                    <div class="grid grid-cols-2 gap-10">
                        <div></div>
                        <div class="text-end">
                            <a href="{{ route('pdf.ReporteCM', ['id_of_report' => $report->id]) }}" target="_blank"
