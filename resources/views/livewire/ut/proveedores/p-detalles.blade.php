                ...
                <div class="container px-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                        ...
                        <div>
                            ...
                            <p class="font-sans text-xs text-gray-500 font-extralight dark:text-gray-200">{{ $proveedor -> Nombre }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-sans text-xs text-gray-500 font-extralight dark:text-gray-200">{{ $proveedor -> Persona }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-sans text-xs text-gray-500 font-extralight dark:text-gray-200">{{ $proveedor -> Direccion }}</p>
                        </div>
                        <div>
                            <x-label for="rfc" value="{{ __('Codigo Postal') }}"/>
                            <p class="font-sans text-xs text-gray-500 font-extralight dark:text-gray-200">{{ $proveedor -> CodigoPostal }}</p>
                        </div>
                        <div>
                            <x-label for="telefono" value="{{ __('Teléfono') }}"/>
                            <p class="font-sans text-xs text-gray-500 font-extralight dark:text-gray-200">{{ $proveedor -> Telefono }}</p>
                        </div>
                        <div>
                            <x-label for="telefono" value="{{ __('Datos de contacto') }}"/>
                            <p class="font-sans text-xs text-gray-500 font-extralight dark:text-gray-200">{{ $proveedor -> DatosContacto }}</p>
                        </div>
                        <div>
