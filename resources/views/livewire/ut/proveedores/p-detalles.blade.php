<div>
    ...
    <div class="py-8">
        <div class="max-w-screen-xl mx-auto">
            ...
            <div class="mt-4 p-6 bg-white border-gray-200 rounded-lg shadow-lg shadow-gray-300 dark:shadow-zinc-700 w-full text-gray-900 dark:text-gray-300 dark:bg-zinc-800 dark:border-zinc-800">
                <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                    <div>
                        <x-label for="telefono" value="{{ __('Vales generados con este proveedor') }}" />
            ...
            <div class="mt-4 p-6 bg-white border-gray-200 rounded-lg shadow-lg shadow-gray-300 dark:shadow-zinc-700 w-full text-gray-900 dark:text-gray-300 dark:bg-zinc-800 dark:border-zinc-800">
                <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                    <div>
                        <x-label for="telefono" value="{{ __('Proveedores registrados con este RFC') }}" />
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
