        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border dark:bg-zinc-800 dark:border-zinc-700">
                        ...
                        <td class="px-4 py-2 text-center">
                            ...
                            {{-- <x-button-icons icon="edit" wire:click="goToEdit({{ $memo }})" /> --}}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            @if ($memorandums->hasPages())
            <div class="px-6 py-3">
                {{ $memorandums->links() }}
            </div>
            @endif
