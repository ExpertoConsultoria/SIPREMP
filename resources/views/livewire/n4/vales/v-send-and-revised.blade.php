                ...
                <tbody>
                    @foreach ($vales as $vale)
                        <tr class="text-center bg-white border-b dark:bg-zinc-800 dark:border-zinc-700">
                            ...
                            <td class="px-4 py-2">
                                <p>{{ $vale->solicitante->name }}</p>
                            </td>
                            <td class="px-4 py-2 text-center">
                                @if ($vale->creation_status === 'Rechazado')
                                    <x-button-colors color="green" wire:click="goToEdit({{ $vale }})">
                                ...
                                @if ($vale->creation_status === 'Rechazado')
                                    <x-button-colors color="red" wire:click="$dispatch('delete',{ id: {{ $vale->id }} })">
