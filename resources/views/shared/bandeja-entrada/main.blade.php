            ...
            <div class="grid justify-center overflow-hidden bg-transparent">
                ...
                @elseif( Auth::user() -> roles[0] -> name === 'N4:SEGE' || Auth::user() -> roles[0] -> name === 'N3:UNTE')
                    <div class="container grid grid-cols-1 gap-16 m-auto px-28 justify-content-center sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
                        <div
                            class="p-6 mt-8 bg-white border border-gray-200 rounded-lg shadow w-60 w-30 text dark:bg-zinc-800 dark:border-zinc-800">
                            <a href="{{ route('bandejaentrada.pendientes') }}" class="text-right">
                                ...
                                <p class="mt-32 text-lg dark:text-gray-200">Solicitudes nuevas <br /> por revisar </p>
                            </a>
                        </div>
                        ...
                        <div
                            ...
                            <a href="{{ route('bandejaentrada.rechazadas') }}" class="text-right">
                                ...
                                <p class="mt-32 text-lg dark:text-gray-200">Solicitudes rechazadas </p>
                            </a>
                        </div>
                    </div>
                @endif
