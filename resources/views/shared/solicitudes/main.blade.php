    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl lg:px-8">
            <div class="grid justify-center overflow-hidden bg-transparent">
                ...
                <div
                    class="container grid grid-cols-1 gap-6 px-8 m-auto justify-content-center sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                    <div
                        ...
                        <a href="{{ route('solicitudes.create') }}" class="text-right">
                            ...
                            <p class="mt-20 text-lg text-gray-800 dark:text-gray-300">Nueva Solicitud de <br />
                                Bienes/Servicios</p>
                        </a>
                    </div>
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                setInterval(getAcendAlert, 10000); //Cada 10 segundo (30 mil milisegundos)
            ...
            window.onload = function() {
                ...
                localStorage.setItem("acendAlert", '');
            ...
            window.onbeforeunload = function() {
                ...
                localStorage.removeItem("acendAlert");
            ...
            function getAcendAlert() {

                var acendAlert = localStorage.getItem("acendAlert");

                $.get('api/acendalert/{{ Auth::user()->id }}', function(data) {
                    ...
                    if (acendAlert != '') {
                        ...
                        if (data != acendAlert) {
                            ...
                            data = JSON.stringify(data);
                            localStorage.setItem("acendAlert", data);
                        }
