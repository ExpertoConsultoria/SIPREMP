                            ...
                            <div
                                ...
                                <a href="{{ route('cajamenor') }}"
                                    ...
                                    <p
                                        ...
                                        CAJA MENOR</p>
                                    <p class="mt-2 text-gray-800 dark:text-gray-400">Crea o revisa las compras de la
                                        Caja Menor</p>
                                </a>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ route('bandejaentrada') }}"
                                    ...
                                    <p class="mt-2 text-gray-800 dark:text-gray-400">Solicitudes generadas por gerentes
                                        de sucursales</p>
                                </a>
                            </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('bandejaentrada') }}"
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Solicitudes por revisar
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('vales') }}" class="grid grid-cols-3 p-5 text-start">
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Generación de vales,
                                                borradores, estatus</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('expedientes') }}" class="grid grid-cols-3 p-5 text-start">
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Contiene los expedientes
                                                completos</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('cajamenor') }}" class="grid grid-cols-3 p-5 text-start">
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Movimientos de caja menor
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('compraconsolidada') }}"
                                        ...
                                        <div>
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                                ...
                                                <g clip-path="url(#clip0_328_85)">
                                                    <path
                                                        d="M45.646 10.2448C45.646 8.83711 45.0967 7.51195 44.101 6.51633L39.1297 1.545C38.1479 0.563086 36.7542 0 35.3672 0H35.0651V10.5469H45.6462L45.646 10.2448Z"
                                                        fill="#515151" />
                                                    <path
                                                        d="M32.102 36.2739C32.4384 35.2525 33.0256 34.3015 33.7911 33.5307L45.6929 21.6769V14.0625H33.3414C32.3698 14.0625 31.6406 13.2763 31.6406 12.3047V0H5.27344C2.36555 0 0 2.36555 0 5.27344V54.7266C0 57.6345 2.36555 60 5.27344 60H40.3726C43.2805 60 45.6929 57.6345 45.6929 54.7266V41.6073L43.7612 43.4921C42.9785 44.268 42.0619 44.8328 41.0284 45.1779L35.4391 47.0439L34.5877 47.0903C33.18 47.0903 31.8479 46.4053 31.0206 45.2586C30.2 44.1171 29.9769 42.6374 30.4232 41.3002L32.102 36.2739ZM8.78906 31.6406H26.3101C27.2817 31.6406 28.0679 32.4268 28.0679 33.3984C28.0679 34.37 27.2817 35.1562 26.3101 35.1562H8.78906C7.81746 35.1562 7.03125 34.37 7.03125 33.3984C7.03125 32.4268 7.81746 31.6406 8.78906 31.6406ZM7.03125 26.3672C7.03125 25.3956 7.81746 24.6094 8.78906 24.6094H26.3101C27.2817 24.6094 28.0679 25.3956 28.0679 26.3672C28.0679 27.3388 27.2817 28.125 26.3101 28.125H8.78906C7.81746 28.125 7.03125 27.3388 7.03125 26.3672ZM7.03125 40.4297C7.03125 39.4581 7.81746 38.6719 8.78906 38.6719H26.3101C27.2817 38.6719 28.0679 39.4581 28.0679 40.4297C28.0679 41.4013 27.2817 42.1875 26.3101 42.1875H8.78906C7.81746 42.1875 7.03125 41.4013 7.03125 40.4297ZM33.3414 49.2188C34.313 49.2188 35.0992 50.005 35.0992 50.9766C35.0992 51.9482 34.3131 52.7344 33.3414 52.7344H22.7945C21.8229 52.7344 21.0367 51.9482 21.0367 50.9766C21.0367 50.005 21.8229 49.2188 22.7945 49.2188H33.3414ZM8.78906 21.0938C7.81746 21.0938 7.03125 20.3075 7.03125 19.3359C7.03125 18.3643 7.81746 17.5781 8.78906 17.5781H33.3414C34.313 17.5781 35.0992 18.3643 35.0992 19.3359C35.0992 20.3075 34.313 21.0938 33.3414 21.0938H8.78906Z"
                                                        fill="#515151" />
                                                    <path
                                                        ...
                                                        fill="#515151" />
                                                    <path
                                                        d="M48.9386 23.3562L37.3617 34.933L42.3545 39.9258C44.9711 37.3088 50.0623 32.2169 53.9307 28.3484L48.9386 23.3562Z"
                                                        fill="#515151" />
                                                    <path
                                                        d="M58.967 18.3146C58.3491 17.6932 57.4392 17.3379 56.4744 17.3379C55.5096 17.3379 54.5999 17.6932 53.9784 18.3164L51.4241 20.8707L56.4161 25.8627C57.8145 24.4642 58.781 23.4976 58.9706 23.3081C60.3437 21.9329 60.3436 19.693 58.967 18.3146Z"
                                                        fill="#515151" />
                                                    <path
                                                        d="M58.9705 23.3082L58.9708 23.3079C58.9752 23.3035 58.9772 23.3015 58.9808 23.2979C58.9772 23.3016 58.9752 23.3036 58.9705 23.3082Z"
                                                        fill="black" />
                                                    <path
                                                        d="M58.9808 23.2978C58.9865 23.2922 58.993 23.2856 58.9964 23.2822C58.9929 23.2857 58.9865 23.2922 58.9808 23.2978Z"
                                                        fill="black" />
                                                    <path
                                                        d="M58.9964 23.2823C59.0078 23.2709 59.008 23.2707 58.9964 23.2823V23.2823Z"
                                                        fill="black" />
                                                </g>
                                                <defs>
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 dark:text-gray-400">Generación de vales, borradores, estatus
                                            </p>
                                        </div>
                                    </a>
                                </div>
                                        ...
                                        <div>
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                                ...
                                                <g clip-path="url(#clip0_307_1718)">
                                                    <path
                                                        d="M20.3572 48.2144H5.35721V54.6427H20.3572V48.2144ZM11.7856 52.4999H8.57162C7.97974 52.4999 7.5 52.0202 7.5 51.4283C7.5 50.8369 7.97974 50.3571 8.57162 50.3571H11.7856C12.3775 50.3571 12.8572 50.8369 12.8572 51.4283C12.8572 52.0202 12.3775 52.4999 11.7856 52.4999ZM17.1428 52.4999H16.0716C15.4797 52.4999 15 52.0202 15 51.4283C15 50.8369 15.4797 50.3571 16.0716 50.3571H17.1428C17.7347 50.3571 18.2144 50.8369 18.2144 51.4283C18.2144 52.0202 17.7347 52.4999 17.1428 52.4999Z"
                                                        fill="#515151" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M37.7335 8.93555L42.1573 0.0750732C42.0392 0.0274658 41.9133 0.00228881 41.7856 0H1.07162C0.943909 0.00228881 0.818024 0.0274658 0.699463 0.0750732L5.12558 8.94012C5.6781 10.0227 6.78818 10.7071 8.00354 10.7144H20.3572V8.37433C18.8814 7.85248 17.9961 6.34323 18.2607 4.80011C18.5252 3.25745 19.8633 2.12952 21.4284 2.12952C22.9939 2.12952 24.332 3.25745 24.5966 4.80011C24.8611 6.34323 23.9758 7.85248 22.5 8.37433V10.7144H34.8537C36.0709 10.7066 37.1819 10.0204 37.7335 8.93555Z"
                                                        fill="#515151" />
                                                    <path
                                                        d="M58.9284 3.21436H45V19.2855H54.6428C55.2347 19.2855 55.7144 19.7653 55.7144 20.3571C55.7144 20.949 55.2347 21.4283 54.6428 21.4283H45V29.9999H54.6428C55.2347 29.9999 55.7144 30.4797 55.7144 31.0716C55.7144 31.663 55.2347 32.1427 54.6428 32.1427H45V35.3571H46.0716C46.6631 35.3571 47.1428 35.8369 47.1428 36.4283C47.1428 37.0202 46.6631 37.4999 46.0716 37.4999H45V40.7144H54.6428C55.2347 40.7144 55.7144 41.1941 55.7144 41.7855C55.7144 42.3774 55.2347 42.8571 54.6428 42.8571H45V56.7855H58.9284C59.5203 56.7855 60 56.3058 60 55.7144V4.28552C60 3.69409 59.5203 3.21436 58.9284 3.21436ZM54.6428 37.4999H51.4284C50.8369 37.4999 50.3572 37.0202 50.3572 36.4283C50.3572 35.8369 50.8369 35.3571 51.4284 35.3571H54.6428C55.2347 35.3571 55.7144 35.8369 55.7144 36.4283C55.7144 37.0202 55.2347 37.4999 54.6428 37.4999ZM54.6428 26.7855H49.2856C48.6942 26.7855 48.2144 26.3058 48.2144 25.7144C48.2144 25.1225 48.6942 24.6427 49.2856 24.6427H54.6428C55.2347 24.6427 55.7144 25.1225 55.7144 25.7144C55.7144 26.3058 55.2347 26.7855 54.6428 26.7855Z"
                                                        fill="#515151" />
                                                    <path
                                                        d="M1.07162 60.0001H41.7856C42.3775 60.0001 42.8572 59.5204 42.8572 58.9285V3.46948L39.6483 9.89786C38.7296 11.7037 36.8797 12.8459 34.8537 12.8573H22.5V15.1974C23.9758 15.7192 24.8611 17.2285 24.5966 18.7711C24.332 20.3143 22.9939 21.4422 21.4284 21.4422C19.8633 21.4422 18.5252 20.3143 18.2607 18.7711C17.9961 17.2285 18.8814 15.7192 20.3572 15.1974V12.8573H8.00354C5.97977 12.8445 4.13223 11.7037 3.21442 9.90015L0 3.47131V58.9285C0 59.5204 0.479736 60.0001 1.07162 60.0001ZM3.21442 48.2145C3.21442 47.0307 4.17389 46.0717 5.35721 46.0717H20.3572C21.5405 46.0717 22.5 47.0307 22.5 48.2145V54.6429C22.5 55.8262 21.5405 56.7857 20.3572 56.7857H5.35721C4.17389 56.7857 3.21442 55.8262 3.21442 54.6429V48.2145Z"
                                                        fill="#515151" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M22.5 5.35727C22.5 5.94916 22.0203 6.42844 21.4284 6.42844C20.8369 6.42844 20.3572 5.94916 20.3572 5.35727C20.3572 4.76538 20.8369 4.28564 21.4284 4.28564C22.0203 4.28564 22.5 4.76538 22.5 5.35727Z"
                                                        fill="#515151" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M22.5 18.2144C22.5 18.8059 22.0203 19.2856 21.4284 19.2856C20.8369 19.2856 20.3572 18.8059 20.3572 18.2144C20.3572 17.6226 20.8369 17.1428 21.4284 17.1428C22.0203 17.1428 22.5 17.6226 22.5 18.2144Z"
                                                        fill="#515151" />
                                                </g>
                                                <defs>
                        ...
                        <div class="grid grid-cols-1 gap-5 mt-5 mb-3 md:gap-12 xl:gap-12 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="p-2 bg-white border border-gray-200 rounded-lg shadow-lg shadow-zinc-300 dark:shadow-none dark:bg-zinc-800 dark:border-zinc-800 ">
                                    ...
                                    <a href="{{route('bandejaentrada.unidadcontrol')}}" class="grid items-center grid-cols-3 p-5 h-60 justify-items-center ">
                                        <div class="">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('solicitudes') }}"
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Generación de solicitudes, borradores, estatus.</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
