                        ...
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ route('solicitudes.create') }}" class="text-right">
                                    ...
                                    <p class="text-lg mt-36 text-gray-800 dark:text-gray-300">Nueva Solicitud de <br />
                                        Bienes/Servicios</p>
                                </a>
                            </div>
                            ...
                            <div
                                ...
                                <a href="{{ route('solicitudes.list') }}" class="text-right">
                                    ...
                                    <p class="text-lg mt-36 text-gray-800 dark:text-gray-300">Estatus de <br />
                                        Solicitudes</p>
                                </a>
                            </div>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="bg-transparent">
                    ...
                    <div class="grid justify-center">
                        <div
                            class="grid grid-cols-1 gap-5 md:gap-12 xl:gap-12 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 mb-3 mt-5">
                            ...
                            <div class="space-y-16">
                                <div
                                    ...
                                    <a
                                        href="{{ route('bandejaentrada') }}"class=" p-5  grid grid-cols-3 text-start justify-items-start ">
                                        <div class="">
