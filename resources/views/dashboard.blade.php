        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="overflow-hidden bg-transparent">
                    ...
                    <div class="grid justify-center">
                        <div
                            class="grid grid-cols-1 gap-5 mb-3 md:gap-12 xl:gap-12 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                            ...
                            <div
                                class="p-2 bg-white border border-gray-200 rounded-lg shadow-lg text dark:bg-gray-800 dark:border-gray-700 ">
