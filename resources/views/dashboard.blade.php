        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="overflow-hidden bg-transparent">
                    ...
                    <div
                        class="p-6 bg-white border border-gray-200 rounded-lg shadow-lg w-30 text dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div
                        class="p-6 mt-8 bg-white border border-gray-200 rounded-lg shadow-lg text dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="grid justify-center">
                        <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                            ...
                            <div
                                ...
                                <a href="{{ route('cajamenor') }}"
                                    ...
                                    <p class="mt-6 text-xl font-semibold leading-tight text-gray-800 font dark:text-gray-200">
                                        CAJA MENOR</p>
                ...
                <div class="overflow-hidden bg-transparent">
                    ...
                    <div class="grid justify-center">
                        <div
                            ...
                            <div>
                                <div
                                    class="p-2 mt-8 mb-2 bg-white border border-gray-200 rounded-lg shadow-lg text dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div
                                    class="p-2 mb-2 bg-white border border-gray-200 rounded-lg shadow-lg text dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="overflow-hidden bg-transparent">
                    ...
                    {{-- MIO, BUENO DEL CARLOS --}}
                    <div class="grid justify-center">

                        <div  class=" mt-12 grid grid-cols-1 gap-5 mb-3 md:gap-12 xl:gap-12 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
