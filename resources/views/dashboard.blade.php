                        ...
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ route('solicitudes.create') }}" class="text-right">
                                    ...
                                    <p class="text-lg text-gray-800 mt-36 dark:text-gray-300">Nueva Solicitud de <br />
                                        Bienes/Servicios</p>
                                </a>
                            </div>
                            ...
                            <div
                                ...
                                <a href="{{ route('solicitudes.list') }}" class="text-right">
                                    ...
                                    <p class="text-lg text-gray-800 mt-36 dark:text-gray-300">Estatus de <br />
                                        Solicitudes</p>
                                </a>
                            </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('bandejaentrada.pendientes') }}"
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Vales de Bienes/Servicios
                                                por revisar</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div
                                    ...
                                    <a href="{{ route('solicitudes') }}"
                                        ...
                                        <div class="col-span-2 ">
                                            ...
                                            <p class="mt-2 text-gray-800 dark:text-gray-400">Generación de solicitudes,
                                                borradores, estatus.</p>
                                        </div>
                                    </a>
                                </div>
                    ...
                    $.get('api/acceptanceAlertUT/{{ Auth::user()->id }}', function(data) {
                        ...
                        if (acceptanceAlertUT != '') {
                            ...
                            if (data != acceptanceAlertUT) {
                                ...
                                data = JSON.parse(data);
                                if (data.folios.length > 0) {
                                    Livewire.dispatch('toastifyAlert', [`Tienes Vales Aprobados`, `/vales`,
                                        '#0b8750', 10000, 'bottom', 'center'
                                    ]);
                                }
                                data = JSON.stringify(data);
