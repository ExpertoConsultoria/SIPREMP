    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl lg:px-8">
            <div class="overflow-hidden bg-transparent">
                ...
                <div
                    class="p-6 bg-white border border-gray-200 rounded-lg shadow-lg w-30 text dark:bg-gray-800 dark:border-gray-700 max-w-screen-xl mx-auto">
                    <p class="text-xl font-semibold text-center text-gray-700 text dark:text-gray-400">¡HOLA, USER!
                        BIENVENIDO AL SIPREMP</p>
                </div>


                <div
                    class="p-8 mt-8 bg-white border border-gray-200 rounded-lg shadow-lg text dark:bg-gray-800 dark:border-gray-700 max-w-screen-lg mx-auto">
